...
###############
if(save_imgs) {
  pdf(file=paste("Images/activity_states_",gsub(" ", "_", title_subj),".pdf",sep=""), width=15, height=9)
  multiplot(plot_orig,plot_trans,plot_orig_cov, plot_transf_cov , plot_resp_orig, plot_resp_transf , cols=3)
  dev.off()
  pdf(file=paste("Images/probability_activity_states_",gsub(" ", "_", title_subj),".pdf",sep=""), width=15, height=9)
